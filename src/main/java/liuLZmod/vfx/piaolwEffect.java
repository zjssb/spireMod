 ...
 */
/*     */
/*     */ public class piaolwEffect extends AbstractGameEffect {
    /*     */   private float x;
    /*     */   private float y;
    /*  14 */   private int frame = 0; private float vY; private float vX; private float scaleY;
    /*  15 */   private float animTimer = 0.05F;
    /*     */   private static final int W = 32;
    private static Texture piao = TextureLoader.getTexture("ModliuLZ/img/vfx/sy_5.png");
    /*     */
    /*     */   public piaolwEffect() {
    ...
    /*     */   public void render(SpriteBatch sb) {
        ...
        /*  61 */     switch (this.frame) {
            /*     */       case 0:
                /*  63 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */       case 1:
                /*  66 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */       case 2:
                /*  69 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */       case 3:
                /*  72 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */       case 4:
                /*  75 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 5:
                /*  78 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 6:
                /*  81 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 7:
                /*  84 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 8:
                /*  87 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 9:
                /*  90 */         renderImg(sb, piao, true, true);
                /*     */         break;
            /*     */       case 10:
                /*  93 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */       case 11:
                /*  96 */         renderImg(sb, piao, false, false);
                /*     */         break;
            /*     */     }
        /*     */   }
    /*     */
