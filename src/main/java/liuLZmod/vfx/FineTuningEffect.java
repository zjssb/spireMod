...
/*    */ public class FineTuningEffect
    ...
    public void update() {
        if (this.duration < 0.6F && !this.clang1) {
            ...
            this.clang1 = true;
            clank(this.owningCard.current_x - 80.0F * this.owningCard.targetDrawScale * Settings.scale, this.owningCard.target_y + 0.0F * this.owningCard.targetDrawScale * Settings.scale);
        }
